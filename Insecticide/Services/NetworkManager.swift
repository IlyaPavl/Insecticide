...
extension NetworkManager {
    func loadCards(offset: Int, limit: Int, search: String, completion: @escaping (Result<Cards, Error>) -> ()) {
    ...
    func fetchItemFor(id: Int, completion: @escaping (Result<Card, Error>) -> ()) {
        var components = apiComponents.item
        components.queryItems = [URLQueryItem(name: "id", value: "\(id)")]
        fetchData(for: Card.self, from: components, completion: completion)
    }
